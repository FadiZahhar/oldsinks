...
// Adding shortcode used in the theme
...
function image_shortcode( $atts, $content = null ) {
	...
	//$thumb_image_url = wp_get_attachment_image_src( $attachment->ID, 'thumbnail' );
	// alt of the image
	...
	return '<img src="' . $large_image_url[0] . '" alt="'. $alt . '" /> </br><p class="caption">' . $image_caption . '</p>';
}
...
if ( ! function_exists( 'alpha_widget_init' ) ) {
	function alpha_widget_init() {
		if ( function_exists( 'register_sidebar' ) ) {
			...
			register_sidebar(
				array(
					'name' => __( 'Collection Widget Area', 'alpha' ),
					'id' => 'collection-sidebar',
					'description' => __( 'Appears on the front end.', 'wpframework' ),
			...
			register_sidebar(
				array(
					'name' => __( 'Install Widget Area', 'alpha' ),
					'id' => 'install-sidebar',
					'description' => __( 'Appears on the front end.', 'wpframework' ),
					'before_widget' => '<div id="%1$s" class="widget col-sm-3 %2$s">',
					'after_widget' => '</div> <!-- end widget -->',
			...
			register_sidebar(
				array(
					...
					'id' => 'footer-sidebar',
					'description' => __( 'Appears on the footer of the page.', 'wpframework' ),
					'before_widget' => '<div id="%1$s" class="widget col-sm-3 %2$s">',
					'after_widget' => '</div> <!-- end widget -->',
					'before_title' => '<h5 class="widget-title">',
					'after_title' => '</h5>',
			...
			register_sidebar(
				array(
					'name' => __( 'Header Widget Area', 'alpha' ),
					'id' => 'header-sidebar',
					'description' => __( 'Appears on the head of the page.', 'wpframework' ),
					'before_widget' => '<div id="%1$s" class="widget col-sm-3 %2$s">',
					'after_widget' => '</div> <!-- end widget -->',
					'before_title' => '<h5 class="widget-title">',
					'after_title' => '</h5>',
